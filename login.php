...
<body class="login-body">
    <!-- 13. Título y nombre del autor fuera del 
    ...
    <div class="container login-container">
        ...
        <form method="post" action="">
            ...
            <!-- 15. Campo para la contraseña -->
            <label for="contrasena">Contraseña: (1234)</label>
            <input type="password" name="contrasena" 
            id="contrasena" required>

            <!-- 16. Botón para enviar el 
             formulario -->
            <input type="submit" value="Iniciar Sesión">
        </form>
    </div>

    <!-- 17. Texto del autor fuera del contenedor con 
     borde -->
    <div class="footer">
        <!-- 18. Muestra el nombre del autor y 
         curso -->
        <p class="autor">
